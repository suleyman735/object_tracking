...
# path_to_frozen_inference_graph = 'dnn/frozen_inference_graph_coco.pb'
# path_coco_model = 'dnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt'
VIDEO = ('file/training_video.mp4')
